            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown messages-menu">
                    <a href="#" class="dropdown-toggle">
                        <span class="hidden-xs">预览首页</span>
                    </a>
                </li>
                ...
                <li class="dropdown messages-menu">
                    <a href="#" class="dropdown-toggle">
                        <span class="hidden-xs">更新首页</span>
                    </a>
                </li>
                ...
                <li class="dropdown messages-menu">
                    <a href="#" class="dropdown-toggle">
                        <span class="hidden-xs">更新栏目</span>
                    </a>
                </li>
                ...
                <li class="dropdown messages-menu">
                    <a href="#" class="dropdown-toggle">
                        <span class="hidden-xs">更新内容</span>
                    </a>
                </li>
                ...
                <li class="dropdown messages-menu">
                    <a href="#" class="dropdown-toggle">
                        <span class="hidden-xs">一键更新</span>
                    </a>
                </li>
                ...
                <li class="dropdown messages-menu">
                    <a href="#" class="dropdown-toggle">
                        <span class="hidden-xs">更新缓存</span>
                    </a>
                </li>
